...
############################spCON###################################################
$pdbname="$line-medium-metainclude";
if(! -e "/nfs/amino-home/baojihe/NEWDIS/record/$pdbname"){print "WARNING!!!!!!!!!!!!!!medium\n";}
 open(GGG,"/nfs/amino-home/baojihe/NEWDIS/record/$pdbname");
...
$pdbname="$line-short-metainclude";
if(! -e "/nfs/amino-home/baojihe/NEWDIS/record/$pdbname"){print "WARNING!!!!!!!!!!!!!!medium\n";}
 open(GGG,"/nfs/amino-home/baojihe/NEWDIS/record/$pdbname");
...
if(! -e "/nfs/amino-home/baojihe/meta-psicov/BAYES/record/$line-long-metainclude"){print "$line        WARNING!!!!!!!!!!!!!!!!!!!!!!!!STAGE1\n";}
 open(GGG,"/nfs/amino-home/baojihe/meta-psicov/BAYES/record/$line-long-metainclude");
