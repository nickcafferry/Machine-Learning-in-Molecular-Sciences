...
$db="/home/travis/build/nickcafferry/Machine-Learning-in-Molecular-Sciences/Machine-Learning-for-Structural-Bioinformatics/PSSpred/nr/nr"; #where NR sequence database is
##############################################################################
